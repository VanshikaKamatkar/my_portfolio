    ...
    <div className="relative flex h-full w-full items-center justify-center bg-transparent">
      ...
      <div className="max-w-[89vw] z-50 text-center">
        ...
        <TextGenerateEffectDemo
          className="mt-4 text-4xl sm:text-6xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent"
          words="Building Scalable Web Apps"
        />

        {/* Introduction */}
        <p className="mt-6 max-w-xl mx-auto text-neutral-300 text-lg">
          Hi! I&apos;m <span className="text-white font-semibold">Prajakta Mondhe</span>,
        </p>
        <div className="mt-2 max-w-xl mx-auto text-neutral-300 text-lg space-y-2">
          <p>
            I&apos;m a passionate developer focused on building scalable, user-friendly web apps using the MERN stack.
            I enjoy turning ideas into reality through code and continuously learning new technologies.
          </p>
          <p>
            Currently seeking opportunities to grow and contribute to impactful projects as an intern.
          </p>
        </div>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <Link href="#projects">
            <button className="relative rounded-lg font-semibold text-white group bg-black overflow-hidden px-0.5 py-0.5">
              ...
              <span className="relative z-10 block bg-black rounded-lg px-6 py-2">
                Show my work
              </span>
            </button>
          </Link>

          <Link href="/Prajakta_Mondhe_Resume.pdf" download>
